...
def add_vehicle(vehicles: list):
    ...
    if issubclass(input_type, ColoredVehicle):    
        ...
        vehicles.append(input_type(brand, model, year, color))
    else:
        vehicles.append(input_type(brand, model, year))
...
vehicles.append(Car("Ford", "F-150", 2022, "gris"))
vehicles.append(Car("Toyota", "Corolla", 2016, "azul"))
